...
Handling of these markers is done in a home-processing step at the very end of text rendering.
...
- fakeFormatString: a momentJS formatting string, littered with special control characters that get home-processed.
...
characters that will eventually be given to moment for formatting, and then home-processed.
    ...
    for (i = 0; i < chunks.length; i++) {
        ...
        if (typeof chunk === 'string') {
            ...
            if (chunk.token in specialTokens) {
                ...
                parts.push(SPECIAL_TOKEN_MARKER + // useful during home-processing
            ...
            parts.push(MAYBE_MARKER + // useful during home-processing
...
Formats a date with a fake format string, home-processes the control characters, then returns.
...
Formats a date into parts that will have been home-processed, EXCEPT for the "maybe" markers.
